...
public class PokerTest
{
    ...
    [Test]
    public void TestTwoPairsHans()
    {
        var hands = new Hands(new string[] { "2H", "2D", "3C", "3S", "4H" });
        Assert.AreEqual(HandsType.TwoPairs, hands.HandsType);
    }

    [Test]
    public void TestThreeOfAKind()
    {
        var hands = new Hands(new string[] { "2H", "2D", "2C", "3S", "4H" });
        Assert.AreEqual(HandsType.ThreeOfAKind, hands.HandsType);
    }

    [Test]
    public void TestFullHouse()
    {
        var hands = new Hands(new string[] { "2H", "2D", "8C", "8S", "8H" });
        Assert.AreEqual(HandsType.FullHouse, hands.HandsType);
    }

    [Test]
    public void TestFourOfAKind()
    {
        var hands = new Hands(new string[] { "2H", "8D", "8C", "8S", "8H" });
        Assert.AreEqual(HandsType.FourOfAKind, hands.HandsType);
    }

    [Test]
    public void TestOnePair()
    {
        var hands = new Hands(new string[] { "2H", "3D", "1C", "8S", "8H" });
        Assert.AreEqual(HandsType.OnePair, hands.HandsType);
    }

    [Test]
    public void TestCompareTwoPairWinsOnePair()
    {
        Poker poker = new Poker();
        Assert.AreEqual(1, poker.Compare(
            new string[] { "7H", "7D", "8S", "8C", "3D" },
            new string[] { "7H", "7D", "4S", "5C", "3D" }));
    }
    ...
    {
        var hands = new Hands(new string[] { "2H", "3D", "4C", "5S", "6H" });
        Assert.AreEqual(HandsType.Straight, hands.HandsType);
    }
